    ...
    <div className="flex flex-col gap-4">
      {sortedDates.map((date) => (
        <div key={date} className="flex flex-col gap-4">
          <h1 className="text-shadow-lg text-shadow-black/80 inline-block rounded-lg bg-accent/40 px-4 py-1 text-3xl font-bold">
                  ...
                  {sortedScores.map((score) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <h2 className="text-xl font-bold">{score.user.name}</h2>
                        ...
                        <p className="whitespace-pre-wrap text-lg">
                          {(() => {
                            ...
                            if (
                              ...
                              const [boxes, link] = prettyScore.split("[link]");
                              return (
                                <>
                                  {boxes}{" "}
                                  <a
